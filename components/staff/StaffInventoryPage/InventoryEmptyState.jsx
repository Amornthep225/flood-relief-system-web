    ...
    return (
        <div className="rounded-3xl border border-slate-100 bg-white px-6 py-16 text-center shadow-sm">
            ...
            <h2 className="mt-4 text-lg font-bold text-slate-700">
                {hasItems ? ui("ไม่พบสิ่งของที่ค้นหา") : ui("ยังไม่มีข้อมูลในคลัง")}
            </h2>

            <p className="mt-1 text-sm text-slate-400">
                {hasItems ? ui("ลองเปลี่ยนคำค้นหาหรือเลือกหมวดหมู่อื่น") : ui("เมื่อรับของบริจาคเข้าคลัง รายการจะแสดงที่หน้านี้")}
            </p>
        </div>
    );
}
