                                ...
                                <div className="flex min-w-0 items-center gap-3">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <p className="mt-0.5 text-xs text-slate-400">
                                            {t(
                                                "donation.tracking.donatedTotal",
                                                {
                                                    total:
