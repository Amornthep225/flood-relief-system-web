...
## Requirement 11 จากเอกสารอาจารย์ — หน้าจัดการศูนย์เดียว

- [x] เปลี่ยนหน้า Admin Centers เป็นฟอร์มแก้ไขศูนย์โดยตรง ตัดตาราง ตัวกรอง pagination และปุ่มเพิ่ม/ลบออกจากหน้านี้
- [x] ใช้ ID จริงจาก API และรองรับศูนย์ที่ปิดใช้งาน
- [x] มี loading, retry, empty state, แจ้งผลบันทึก และคืนค่าที่บันทึกไว้
- [x] เชื่อมไปคลังของศูนย์เดิมด้วย centerId
- [x] แจ้งข้อผิดพลาดเมื่อข้อมูลมีหลายศูนย์ ไม่เลือกศูนย์แทนผู้ใช้
