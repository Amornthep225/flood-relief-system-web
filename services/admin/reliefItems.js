...
export const getReliefItems=(signal)=>request(`${API_URL}/relief-items`,{method:"GET",signal});
export const createReliefItem=(payload)=>request(`${API_URL}/relief-items`,{method:"POST",body:JSON.stringify(payload)});
export const updateReliefItem=(id,payload)=>request(`${API_URL}/relief-items/${encodeURIComponent(id)}`,{method:"PUT",body:JSON.stringify(payload)});
export const updateReliefItemStatus=(id,isActive)=>request(`${API_URL}/relief-items/${encodeURIComponent(id)}/status`,{method:"PUT",body:JSON.stringify({isActive})});
